...
def fetch_data(params, output_path):
    try:
        ...
        logging.info(f"Requesting URL: {url}")  # Log URL for debugging
        ...
        if response.status_code == 200 and "text/csv" in response.headers.get("Content-Type", ""):
            ...
            logging.warning(f"Failed to download: {output_path}. Status code: {response.status_code}. Content-Type: {response.headers.get('Content-Type')}")
            return False
    ...
    for file in files_to_process:
        ...
        for day in daily_dates:
            ...
            query_params = {
                ...
                "atedatacontrato": day,
                "pais": "187"  # This line ensures the query works properly
            }
